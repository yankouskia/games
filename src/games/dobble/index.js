...
const FLAG_INFO = [
  ['АРГЕНТИНА','БУЭНОС-АЙРЕС'],['АВСТРАЛИЯ','КАНБЕРРА'],['АВСТРИЯ','ВЕНА'],['БЕЛЬГИЯ','БРЮССЕЛЬ'],
  ['БРАЗИЛИЯ','БРАЗИЛИА'],['КАНАДА','ОТТАВА'],['ЧИЛИ','САНТЬЯГО'],['КИТАЙ','ПЕКИН'],
  ['КОЛУМБИЯ','БОГОТА'],['ХОРВАТИЯ','ЗАГРЕБ'],['ЧЕХИЯ','ПРАГА'],['ДАНИЯ','КОПЕНГАГЕН'],
  ['ЭКВАДОР','КИТО'],['ФИНЛЯНДИЯ','ХЕЛЬСИНКИ'],['ФРАНЦИЯ','ПАРИЖ'],['ГЕРМАНИЯ','БЕРЛИН'],
  ['ГРЕЦИЯ','АФИНЫ'],['ВЕНГРИЯ','БУДАПЕШТ'],['ИСЛАНДИЯ','РЕЙКЬЯВИК'],['ИНДИЯ','НЬЮ-ДЕЛИ'],
  ['ИНДОНЕЗИЯ','ДЖАКАРТА'],['ИРЛАНДИЯ','ДУБЛИН'],['ИЗРАИЛЬ','ИЕРУСАЛИМ'],['ИТАЛИЯ','РИМ'],
  ['ЯПОНИЯ','ТОКИО'],['КАЗАХСТАН','АСТАНА'],['ЮЖНАЯ КОРЕЯ','СЕУЛ'],['ЛАТВИЯ','РИГА'],
  ['ЛИТВА','ВИЛЬНЮС'],['ЛЮКСЕМБУРГ','ЛЮКСЕМБУРГ'],['МЕКСИКА','МЕХИКО'],['МОНАКО','МОНАКО'],
  ['НИДЕРЛАНДЫ','АМСТЕРДАМ'],['НОВАЯ ЗЕЛАНДИЯ','ВЕЛЛИНГТОН'],['НОРВЕГИЯ','ОСЛО'],
  ['ПАНАМА','ПАНАМА'],['ПАРАГВАЙ','АСУНСЬОН'],['ПЕРУ','ЛИМА'],['ФИЛИППИНЫ','МАНИЛА'],
  ['ПОЛЬША','ВАРШАВА'],['ПОРТУГАЛИЯ','ЛИССАБОН'],['РУМЫНИЯ','БУХАРЕСТ'],['РОССИЯ','МОСКВА'],
  ['СИНГАПУР','СИНГАПУР'],['СЛОВАКИЯ','БРАТИСЛАВА'],['СЛОВЕНИЯ','ЛЮБЛЯНА'],['ИСПАНИЯ','МАДРИД'],
  ['ШВЕЦИЯ','СТОКГОЛЬМ'],['ШВЕЙЦАРИЯ','БЕРН'],['ТАЙВАНЬ','ТАЙБЭЙ'],['ТАИЛАНД','БАНГКОК'],
  ['ТУРЦИЯ','АНКАРА'],['УКРАИНА','КИЕВ'],['ВЕЛИКОБРИТАНИЯ','ЛОНДОН'],['США','ВАШИНГТОН'],
  ['УРУГВАЙ','МОНТЕВИДЕО'],['ВЬЕТНАМ','ХАНОЙ']
];
...
function renderCard(cardEl, cardSymbols, player) {
  ...
  const sizeOptions = [52, 44, 56, 40, 50, 46, 54, 42];
  const placed = [];
